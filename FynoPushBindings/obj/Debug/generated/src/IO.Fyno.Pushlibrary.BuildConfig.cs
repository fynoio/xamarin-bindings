...
namespace IO.Fyno.Pushlibrary {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.fyno.pushlibrary']/class[@name='BuildConfig']"
	[global::Android.Runtime.Register ("io/fyno/pushlibrary/BuildConfig", DoNotGenerateAcw=true)]
	public sealed partial class BuildConfig : global::Java.Lang.Object {
		...
		public const string LibraryPackageName = (string) "io.fyno.pushlibrary";

		static readonly JniPeerMembers _members = new XAPeerMembers ("io/fyno/pushlibrary/BuildConfig", typeof (BuildConfig));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.fyno.pushlibrary']/class[@name='BuildConfig']/constructor[@name='BuildConfig' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
