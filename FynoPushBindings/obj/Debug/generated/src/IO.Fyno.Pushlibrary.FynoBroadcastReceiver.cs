...
namespace IO.Fyno.Pushlibrary {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.fyno.pushlibrary']/class[@name='FynoBroadcastReceiver']"
	[global::Android.Runtime.Register ("io/fyno/pushlibrary/FynoBroadcastReceiver", DoNotGenerateAcw=true)]
	public partial class FynoBroadcastReceiver : global::Android.Content.BroadcastReceiver {
		static readonly JniPeerMembers _members = new XAPeerMembers ("io/fyno/pushlibrary/FynoBroadcastReceiver", typeof (FynoBroadcastReceiver));
		...
		protected FynoBroadcastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.fyno.pushlibrary']/class[@name='FynoBroadcastReceiver']/constructor[@name='FynoBroadcastReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe FynoBroadcastReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::IO.Fyno.Pushlibrary.FynoBroadcastReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.fyno.pushlibrary']/class[@name='FynoBroadcastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
